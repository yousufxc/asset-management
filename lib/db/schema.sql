...
-- ----------------------------------------------------------------------------
-- MORTGAGES — bank mortgage financing for properties.
-- One mortgage per property (FK cascade-deletes when the property is removed).
...
DROP VIEW IF EXISTS v_mortgages;
CREATE VIEW IF NOT EXISTS v_mortgages AS
